                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        formatter: function (value, row, index) {
                            ...
                            // return e + d+g;
                            var g = '<a class="btn btn-success btn-sm" href="#" mce_href="#" title="点击启用,当前状态为停用" onclick="changeonoff(\''
                                + row.id
                                + '\',\''
                                + 0
                                + '\')"><i class="fa fa-hourglass-start"></i>启用</a> ';
                            var f = '<a class="btn btn-danger btn-sm" href="#" mce_href="#" title="点击停用,当前状态为启用生效" onclick="changeonoff(\''
                                + row.id
                                + '\',\''
                                + 1
